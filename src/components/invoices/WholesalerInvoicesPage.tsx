    ...
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        {selectedInvoice ? (
          <div className="space-y-6">
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3 sm:p-6">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {selectedInvoice.items.map((item, index) => (
                    <div
                      key={index}
                      className="flex justify-between text-sm py-2 border-b border-gray-100 dark:border-gray-800"
                    >
              ...
              {/* Summary */}
              <div className="space-y-2 rounded-lg bg-gray-50 p-4 dark:bg-gray-800 mb-6">
      ...
      <div className="lg:col-span-1 space-y-6 order-1 lg:order-2">
        ...
        <button
          ...
          className="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
        >
          تصدير التقرير
        </button>
